% 1. Change the file name for saving as a different file
% 2. See the "ADDED BY ME" section at the bottom
...
obs_im = imread('../images/motion0050.jpg');  
...
if SYNTHETIC
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  ADDED BY ME (1st & 3rd line below)  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  cd('../code')
...
fname = mfilename;  % mfilename stores the file name by default ie., "motion0050"
save(fname);
